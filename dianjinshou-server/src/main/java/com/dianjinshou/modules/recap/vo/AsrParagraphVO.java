...
public class AsrParagraphVO {
    ...
    public static AsrParagraphVO fromEntity(AsrParagraph p) {
        AsrParagraphVO vo = new AsrParagraphVO();
        vo.setId(p.getId());
        vo.setParagraphIndex(p.getParagraphIndex());
        vo.setStartTime(p.getStartTime());
        vo.setEndTime(p.getEndTime());
        vo.setNaturalTime(p.getNaturalTime());
        vo.setTextContent(p.getTextContent());
        vo.setWordCount(p.getWordCount());
        vo.setWordsPerMin(p.getWordsPerMin());
        vo.setOnlineCount(p.getOnlineCount());
        vo.setBarrageCount(p.getBarrageCount());
        vo.setTransactionCount(p.getTransactionCount());
        vo.setInteractionRate(p.getInteractionRate());
        vo.setTransactionRate(p.getTransactionRate());
        vo.setSalesAmount(p.getSalesAmount());
        vo.setUvValue(p.getUvValue());
        vo.setSpeakerId(p.getSpeakerId());
        vo.setScriptCategory(p.getScriptCategory());
        vo.setIsHighlighted(p.getIsHighlighted());
        return vo;
    }
