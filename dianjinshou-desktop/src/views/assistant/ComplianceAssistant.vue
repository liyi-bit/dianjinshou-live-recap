...
async function fetchPresets() {
  try {
    const res = await aiApi.getPresets('compliance')
...
async function fetchChatHistory() {
  try {
    const params: any = { assistantType: 'compliance' }
...
const defaultPresets: PresetQuestion[] = [
  { id: 1, title: '检测直播敏感词使用情况', desc: '', color: '#F53F3F' },
  { id: 2, title: '分析是否存在虚假宣传', desc: '', color: '#FF7D00' },
  { id: 3, title: '检查绝对化用语风险', desc: '', color: '#F5A623' },
  { id: 4, title: '分析引导场外交易风险', desc: '', color: '#722ED1' },
  { id: 5, title: '检测涉政涉黄敏感内容', desc: '', color: '#F76560' },
  { id: 6, title: '检查商品描述合规性', desc: '', color: '#0FC6C2' },
  { id: 7, title: '分析评论区违规风险', desc: '', color: '#3491FA' },
  { id: 8, title: '生成合规修改建议', desc: '', color: '#00B42A' }
]

const defaultComparisonPresets: PresetQuestion[] = [
  { id: 1, title: '对比两场直播敏感词使用', desc: '', color: '#F53F3F' },
  { id: 2, title: '对比两场虚假宣传风险', desc: '', color: '#FF7D00' },
  { id: 3, title: '对比两场违规表述差异', desc: '', color: '#F5A623' },
  { id: 4, title: '对比两场合规改善情况', desc: '', color: '#00B42A' },
  { id: 5, title: '对比两场敏感话题处理方式', desc: '', color: '#722ED1' },
  { id: 6, title: '对比两场引导方式合规性', desc: '', color: '#3491FA' }
]
...
<template>
  <div class="assistant-page">
    ...
    <!-- ===== 顶部导航栏 ===== -->
    <div class="top-nav">
      <span class="back-link" @click="goBack">&lsaquo; AI违规助手</span>
    </div>
        ...
        <div class="chat-messages" ref="messagesRef">
          <div v-if="aiMessages.length === 0" class="welcome-area">
            <div class="welcome-text">
              ...
              我是你的AI违规助手，我能帮你：检测敏感词、识别虚假宣传、排查违规风险、生成合规建议。
            </div>
